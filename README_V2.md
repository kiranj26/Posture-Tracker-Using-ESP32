...
| 10 | PCB V2 schematic + layout + fabrication (JLCPCB) | 🔄 PCB complete — awaiting order | Schematic ✅ ERC clean. Layout ✅ fully routed. DRC ✅ 0 errors, 0 unconnected, 2 cosmetic silk warnings. Gerbers ✅ exported to `hardware/pcb/v2/`. JLCPCB order ⏳ pending. See `feature/pcb-schematic` |
...
> Branch: `feature/pcb-schematic` → PR into `release/v2-product`
...
- **Speaker** — MECCANIXITY 20mm 8Ω 1W with pre-soldered cable → plugs into LS1
- **LRA motor** — Vybronics VG1030001XH → plugs into J3
...
<!-- Capture from KiCad: View → 3D Viewer → screenshot → save as hardware/assets/pcb_v2_3d.png -->
![PCB V2 3D render](hardware/assets/pcb_v2_3d.png)

### PCB — Top View

<!-- Capture from KiCad PCB Editor: fit board in view → screenshot → save as hardware/assets/pcb_v2_top.png -->
![PCB V2 top view](hardware/assets/pcb_v2_top.png)

### Schematic

<!-- Capture from KiCad: File → Export → Export as Image → 150dpi PNG → save as hardware/assets/schematic_v2.png -->
